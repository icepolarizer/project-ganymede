...
![1547477501945](/home/kenixer/.config/Typora/typora-user-images/1547477501945.png)
...
> 거창해 보이지만, 김현승(Hyesung Kim - HK와 나는 이 주제에 대해 대략 2달 전부터 관심을 가지고 연구해 왔었다. 일종의 스터디를 시작했다. 나는 프로그래밍에, HK는 물리에 익숙하기 때문에 서로 도와가면서 진행하는 중이다.
